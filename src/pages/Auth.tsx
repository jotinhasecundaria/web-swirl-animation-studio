...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center pt-14 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900 p-4">
